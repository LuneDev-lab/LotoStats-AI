...
import { Dna, LogOut, Clover } from 'lucide-react';

interface LottoGeneratorProps {
  onLogout: () => void;
}

const LottoGenerator: React.FC<LottoGeneratorProps> = ({ onLogout }) => {
    ...
    <div className="min-h-screen flex flex-col font-sans">
      <header className="bg-emerald-900 text-white shadow-lg sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <button
            onClick={onLogout}
            className="flex items-center gap-2 text-sm text-emerald-300 hover:text-white transition-colors"
          >
